...
import logo2 from "../assets/lycalogo.png"
...
const Navbar = () => {
    ...
    return (
        <nav className="fixed top-4 left-0 right-0 z-50 m-2">
            <div className="text-neutral-500 bg-black/60 backdrop-blur-md max-w-1xl mx-auto px-4 py-3 flex justify-between items-center rounded-xl border border-neutral-800">
                {/* left: logo */}
                <div className="flex items-center">
                    <img src={logo2} alt="logo" className="cursor-pointer h-12 w-auto object-contain"/>
                </div>
                ...
                <div className="hidden md:flex space-x-4 items-center">
                    ...
                    <a href="#" className=" border bg-white-600 text-white py-2 px-4 rounded-lg hover:bg-blue-500 transition-colors">
                        Start Free Trial
                    </a>
                </div>
