...
export const HERO_CONTENT = {
  ...
  subHeading:
    "Optimize your streams, track real-time analytics, and engage your audience effortlessly—all in one place. Perfect for Twitch, YouTube, and Facebook users.",
  callToAction: {
...
export const PLANS_CONTENT = {
  ...
  sectionDescription:
    "Lyca offers flexible pricing plans to fit every streamer's needs, from beginner to pro.",
  ...
  plans: [
    ...
    },
    {
      ...
      price: "$19.99/month",
      description:
        "For professionals who want more advanced tools to grow their audience.",
      features: [
        "Advanced analytics",
    ...
    },
    {
      ...
      price: "$49.99/month",
      description:
        "For professional users who need cutting-edge tools and insights.",
      features: [
...
export const TESTIMONIALS_CONTENT = {
  ...
  sectionDescription:
    "Hear from some of the top professionals who use Lyca to engage with their audience and grow their channels.",
  reviews: [
    {
      name: "Alice Johnson",
      title: "Content Creator",
      review:
        "Lyca has revolutionized the way we manage our content subscriptions. The intuitive dashboard and real-time analytics have made it easier to track our progress and optimize our offerings. Highly recommended!",
      image: user1,
    },
    {
      name: "Bob Smith",
      ...
      review:
        "The team at Lyca has been fantastic! Their support is responsive and knowledgeable. The platform itself is versatile and has helped us streamline our subscription management, saving us time and increasing efficiency.",
      image: user2,
    },
    {
      name: "Carla Mendes",
      ...
      review:
        "Lyca's automated billing and comprehensive analytics have been game-changers for our product team. We can now easily track user engagement and make data-driven decisions to enhance our service offerings.",
      image: user3,
    },
    {
      name: "David Lee",
      ...
      review:
        "Using Lyca, we've been able to increase our customer retention rates. The platform's user-friendly interface and powerful features have provided our customers with a seamless experience, leading to higher satisfaction.",
      image: user4,
    },
    {
      name: "Ella Fernandez",
      title: "UX Designer",
      review:
        "Lyca's flexibility and ease of use have made it a key tool in our design process. We can quickly adjust our subscription plans and monitor the impact on user engagement, allowing for a more responsive approach.",
      image: user5,
    },
    {
      name: "Frank Wilson",
      title: "Data Analyst",
      review:
        "Lyca provides us with detailed insights into our subscription metrics. The advanced reporting tools have enabled us to identify trends and make informed decisions to optimize our growth strategy.",
      image: user6,
    },
  ],
};
  ...
  sections: [
    ...
    },
    {
      ...
      links: [
        ...
        { text: "Top Strategies for New Users", url: "#" },
        ...
        { text: "Advanced Analytics Guide for Professionals", url: "#" },
      ],
    },
  ],
  platformsText:
    "Streaming Platforms | Twitch | YouTube | Discord | Facebook Gaming",
  copyrightText: "© 2024 Lyca, Inc. All rights reserved.",
};
